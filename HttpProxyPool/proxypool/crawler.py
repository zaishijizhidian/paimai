...
class Crawler(object, metaclass=ProxyMetaclass):
    ...
    def crawl_xdaili(self):
        # url = 'http://api.xdaili.cn/xdaili-api//greatRecharge/getGreatIp?spiderId=ccaaaf60e9e146a4919716cb36ca83b8&orderno=YZ20188235094mwoxUG&returnType=2&count=20'
        url = 'http://api.xdaili.cn/xdaili-api//greatRecharge/getGreatIp?spiderId=ccaaaf60e9e146a4919716cb36ca83b8&orderno=YZ20188235094mwoxUG&returnType=2&count=20'
        html = get_page(url)
        if html:
