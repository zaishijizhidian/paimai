...
class SipaiSpider(scrapy.Spider):
    ...
    # start_urls = ['https://sf.taobao.com/item_list.htm?spm=a213w.7398504.filter.49.U2lXrt&category=50025969&sorder=2&auction_start_seg=-1']
    # start_urls = ['https://sf.taobao.com/item_list.htm?spm=a213w.7398504.filter.51.9WEfB9&category=50025969&sorder=5&auction_start_seg=-1']
    #更新时间２０１８-04-01 至 2018-04-17
    start_urls = ['https://sf.taobao.com/item_list.htm?spm=a213w.7398504.filter.50.fLcjE6&sorder=4&auction_start_seg=0&auction_start_from=2018-04-20&auction_start_to=2018-04-23',
                  'https://sf.taobao.com/item_list.htm?spm=a213w.7398504.filter.51.mnDlcn&sorder=5&auction_start_seg=0&auction_start_from=2018-04-20&auction_start_to=2018-04-23']
    ...
    def parse_detail_url(self, response):
            ...
            if status_text is not None:
                ...
                status_text = response.xpath("//div[@class='pm-main-l auction-interaction']//h1/text()").extract_first()
                if status_text is not  None:
                    if (status_text == "本场拍卖已撤回 ！") or (status_text == "本场变卖已撤回 ！"):
                        item["deal_status"] = "03"
                    elif (status_text == "本场拍卖已中止 ！") or (status_text == "本场拍卖已暂缓 ！") or (status_text == "本场变卖已中止 ！") or (status_text == "本场变卖已暂缓 ！"):
                        item["deal_status"] = "04"
